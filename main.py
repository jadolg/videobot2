        ...
        try:
            ...
            try:
                ...
                await update.message.reply_text(
                    text="Looks like something went wrong uploading the video to telegram. It possibly is bigger than "
                    "50Mb."
                )
            os.remove(output_file)
        except youtube_dl.utils.DownloadError as error:
            print(error)
            await update.message.reply_text(text="I could not download this 😅")
